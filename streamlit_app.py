...
# -----------------------------------------------------------------------------
st.set_page_config(
    page_title="Market Lens 2.2｜市場透視",
    page_icon="◉",
    layout="wide",
...
st.sidebar.markdown(
    ...
    <div class="ml-brand">
      ...
      <div><div class="ml-brand-title">Market Lens <span class="ml-version">2.2</span></div><div class="ml-brand-sub">Ryan's buy-side research workspace</div></div>
    </div>
    """,
    unsafe_allow_html=True,
)
...
st.markdown(
    f'<div class="ml-footer">Market Lens 2.2 · Refreshed {datetime.now(timezone.utc).strftime("%Y-%m-%d %H:%M UTC")} · Educational use only.</div>',
    unsafe_allow_html=True,
)
